...
interface API {
    ...
    fun setFavouritesLocal(newFav: List<Book>)
    ...
    @Throws(NoInternetException::class)
    suspend fun getBooksMatchingSearch(title: String, author: String, year: Year_type): List<Book>
    fun takePhoto(): Img_type
    fun shareBook(book: Book, contact: Contact)
